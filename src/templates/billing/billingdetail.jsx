...
const BillingDetail = () => {
    const [mobphone, setmobPhone] = useState("+9239699999");
    const handleChangeMob = (newPhone) => {
        setmobPhone(newPhone);
    };
    const [landline, setlandline] = useState("+9239699999");
    ...
    return (
        <div className='template-content w-100 pt-100' >
            ...
            <div className=' row m-0 w-100 '>
                        ...
                        {editbilldetail ?
                            <form>
                                ...
                                <div className="justify-content-end d-flex align-items-center ">
                                    <button className='btn-brown-bg' onClick={() => { seteditbilldetail(!editbilldetail) }}>
                                        Save and Continue
                                    </button>
                                </div>
                            </form>
                ...
                <div className='col-xl-4 col-md-5 col-12 p-0 col-eq-height'>
                    <div className='column-sub p-30px mt-md-0 mt-4 ml-md-4 col-eq-height'>
                        <div className=' pb-30px bb-2px  mb-30px border-skin'>
                        ...
                        <div className='d-flex justify-content-between pb-30px mb-30px border-bottom align-items-center flex-wrap font-18'>
                ...
                <div className=' row m-0 w-100 mt-4'>
                    <div className='col-xl-8 col-md-7 col-12 p-0 col-eq-height'>
                        <div className='column-sub p-30px col-eq-height'>
                            ...
                            <form>
                                <div className="d-flex flex-column mb-32 w-50 mr-lg-4 mr-sm-4 mr-md-0">
                                    <label
                                        className="font-16 font-weight-600 pb-2 "
                                        htmlFor="name">
                                        Name on Card
                                ...
                                <div className="d-flex flex-column mb-32 w-50">
                                    <label
                                        className="font-16 font-weight-600 pb-2 "
                                        htmlFor="name">
                                        Card Number
                                ...
                                <div className='d-flex flex-sm-row flex-md-column w-50 flex-lg-row flex-column justify-content-between align-items-center'>
                                    <div className="d-flex flex-column mb-32  mr-lg-4 mr-sm-4 mr-md-0">
                                        <label
                                            className="font-16 font-weight-600 pb-2 "
                                            htmlFor="name">
                                            Expiry Date
                                        ...
                                        <div className='d-flex align-items-center'>
                                            <input
                                                ...
                                                placeholder='MM'
                                                className='h-48px form-control border-grey p-input-style font-16 font-weight-400 '
                                                name="month"
