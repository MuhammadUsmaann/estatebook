    ...
    return (
        <div className='template-main'>
            <div className='row m-0'>
                <div className='col-md-7 p-0 col-12 text-left'>
                    <div className='d-flex flex-xl-row flex-column align-items-xl-center align-items-start'>
                        <img src={santanaImage} />
                        <div className='pl-xl-5 flex-xl-column flex-row align-items-start'>
                            <div>
                                <p className='font-36 font-weight-700 pb-2'> Santana Team</p>
                                <p className='font-18 pt-1 pb-5 text-skin-brown font-weight-500'>#RC8719032</p>
                            </div>
                ...
                <div className='col-md-5 p-0 col-12 text-right'>
                    <div className='d-flex flex-lg-row flex-column align-items-lg-center align-items-start justify-content-between mb-lg-5 mb-3 '>
                        <button className='premium-btn p-3  font-12 font-weight-600 mb-lg-0 mb-3'> <Premiumicon /><span className='pl-1'>Verified Company</span></button>
            ...
            <div className='d-xl-none mt-md-0 mt-3  d-flex justify-content-between flex-wrap'>
                <div className='font-18 pb-3 font-weight-400 d-flex align-items-center'>
                    <PhoneIcon />
                    <span className='pl-3'>+91 012 3456 789</span>
                </div>
